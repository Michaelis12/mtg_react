                ...
                {cards.map(card => ( 
                  <div className="cards-details" key={card.id}>                       
                        ...
                        <div className='classic-formats-deck-details'>
                          ...
                          <AddButton onClick={() => selectCardCedh(card)} style={{ margin : '2%', border: 'none' }}
              ...
              <div className='popup-bckg'>
                       <div className='popup-cards-selected' style={{ backgroundImage: `url(${backgroundPopup})`}} >
                                              ...
                                              <div className='cards-selected-container'>
                                                <img className='card-add-img' src={cardImage && cardImage.startsWith('/uploads/') ? `https://christian-missie-bdt-36df9a45.koyeb.app${cardImage}` : cardImage} alt="deck-img" />
                                                ...
                                                <div className='valid-popup-container'>                                   
                                                  <button className='valid-popup' onClick={() => addCards()} disabled={displayLoading}>
                                                      <h4 className='valid-popup-title'>Ajouter au deck</h4>
                                                  </button>
                                                </div>
                       </div> 

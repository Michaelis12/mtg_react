   ...
   const selectEditions = (newEdition) => {
    ...
    <Section> 
      ...
      <div className='new-deck-attributes'>
            {cedhID !== "" && image === "" &&(
              <div>
                <img className="new-cedh-image" src={cedh.image && cedh.image.startsWith('/uploads/') ? `https://localhost:8443${cedh.image}` : cedh.image} alt="Cedh mtg" onMouseEnter={()=>setDetailsCedh(true)} 
             ...
             <div className='display-objects-section'>
              ...
              { displayCards === "id" && (
                <div className='map-cards-section'>
                  ...
                  {cards.map(card => ( 
                      ...
                      <img className="card-img-zoom" src={card.image && card.image.startsWith('/uploads/') ? `https://localhost:8443${card.image}` : card.image} alt="Card-image"/>
                      )}  
                  </div>
                  ))}
              ...
              { displayCards === "popularity" && (
                <div className='map-cards-section'>
                  ...
                  {topCards.map(card => ( 
                      <div className="cards-details" key={card.id}>
                          <img className="cards-img" src={card.image && card.image.startsWith('/uploads/') ? `https://localhost:8443${card.image}` : card.image} alt="Card-image" 
               ...
               {/*La carte finale format desktop*/}
                <div className="new-deck-body" style={{ backgroundImage: `url(${backgroundPopup})`}}>
                          ...
                          <div className="deck-content">
                              <img className="deck-selected-img" src={image.startsWith('/uploads/') ? `https://localhost:8443${image}` : image} alt="Deck mtg"/>
                ...
                <div className="deck-card-medium">
                                    <div className="img-container">
                                                          <img className="new-deck-img-mobile" src={image.startsWith('/uploads/') ? `https://localhost:8443${image}` : image} alt="Deck mtg"/>
                                    </div>
                ...
                <div className="deck-card-mobile">
                  ...
                  <div className="new-deck-body-mobile" style={{ backgroundImage: `url(${backgroundPopup})`}} >
                    ...
                    <div className='card-line-attribut'>                        
                      ...
                      <button style={{marginBottom: '5%', marginTop: '5%', paddingLeft: '2%', paddingRight: '2%'}} className='valid-popup' onClick={() => createDeck()} ><h4>Créer le deck</h4></button>                                          
                    </div> 
                </div> 
                              ...
                              <div className="deck-selected-attributs" >
                                  ...
                                  <div className='cedh-line-attribut'>
                                      ...
                                      {detailsCard && detailsCard.id === cedh.id && (
                                            <img className="cedh-img-zoom" src={cedh.image && cedh.image.startsWith('/uploads/') ? `https://localhost:8443${cedh.image}` : cedh.image} alt="Card-image"/>
                                        )} 
                                </div> 

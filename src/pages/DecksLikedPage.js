    ...
    // Filtre recherche
        ...
        const getDecksWithDate = async () => {
            try {
                ...
                const response = await axiosInstance.get('f_user/getDecksLikedFilter', {
                  params,
                  paramsSerializer: {
        ...
        const displayMoreDecksByDate = async () => {
                        ...
                        try {
                            ...
                            const request = await axiosInstance.get(`f_user/getDecksLikedFilter`, {
                                    params,

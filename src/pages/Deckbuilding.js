                ...
                { updateDeck && (
                    <div className='popup-bckg'>
                     <div className='set-attributs-deck' style={{ backgroundImage: `url(${backgroundPopup})`}}>
                                ...
                                />
                                <img className='deck-selected-img' src={newImage && newImage.startsWith('/uploads/') ? `https://christian-missie-bdt-36df9a45.koyeb.app${newImage}` : newImage} alt="deck-img" />
                                              ...
                                              <div className='cards-selected-container'>
                                                <img className='card-add-img' src={
                                                    cardImage
                                                        ...
                                                        ? `https://christian-missie-bdt-36df9a45.koyeb.app${cardImage}`
                                                        : cardImage
                                                        : defaultImg
                                                    }
                                                    alt="deck-img" />
                                                <div className='cards-deck-unit-container'> 
                                                  {cardsSelectedUnit.map(card => ( 
                                                    <div className="land-text-details" id='land-card'  key={card.id}> 
                                                        ...
                                                        {detailsCard && detailsCard.id === card.id && (
                                                        <img className="card-img-zoom" src={card.image && card.image.startsWith('/uploads/') ? `https://christian-missie-bdt-36df9a45.koyeb.app${card.image}` : card.image} alt="Card-image"/>
                                                        )} 
                                                    </div>
                        ...
                        <div className='popup-cards-selected-mobile' style={{ backgroundImage: `url(${backgroundPopup})`}}>
                            ...
                            <div className='cards-selected-container-mobile'>
                              ...
                              <img className="card-selected-img-mobile"
                                              src={cardsSelectedUnit[cardNumber].image && cardsSelectedUnit[cardNumber].image.startsWith('/uploads/') ? `https://christian-missie-bdt-36df9a45.koyeb.app${cardsSelectedUnit[cardNumber].image}` : cardsSelectedUnit[0].image} alt="Card mtg"/>
                              <div className='cards-deck-unit-container'> 

...
const CardsLikedPage = () => {
    ...
    const [cardsLikedLength, setCardsLikedLength] = React.useState("")
     ...
     const displayTopCards = () => {
      ...
      const getCardsLiked = async () => {
            try {
                  ...
                  setCardsLikedId(listId)
                  setCardsLikedLength(listId.length)
      ...
      const hearthIconCard = (id) => {
                        if(!cardsLikedId.some(cardID => cardID === (id))) {
                            ...
                            return (<FaHeart size="2em" className='icon-for-dislike' color="red"/>)
                        }
      }
      ...
      const dislikeCard = async (id) => {
                        try {
                           ...
                           setCardsLikedLength(cardsLikedId.length - 1)
      ...
      const maskBaseLand = (value) => {
        ...
        return (  
            ...
            <div className='title-cards-container'>
              <Title title={'Cartes likées (' + cardsLikedLength + ')'} />
            </div> 
          ...
          { displayCards === "id" && (
              <div className='map-cards-section'>
                ...
                <IconButton   
                    ...
                    icon={<FaHeart size="2em" className='icon-for-dislike' color="red"/>} 
                />
                    <p className='card-page-likenumber'>{card.likeNumber} <FaHeart style={{position:'relative', marginBottom: '3px'}}
      ...
      { displayCards === "id" && cards.length > 0 && hasMore && (
       ...
       { displayCards === "popularity" && ( 
            <div className='map-cards-section'>
              ...
              <ParagraphLikeNumber text={card.likeNumber} iconStyle={{position:'relative', marginBottom: '3px'}}/>
